...
// ─────────────────────────────────────────────────────────────────────────
// /12.3display — 12.3" no-touch kiosk variant of the main dashboard.
//
...
//
// Only difference from app/page.tsx: every vehicle-card control (Tesla
// lock/unlock, AC on/off, charge start/stop, tap-to-set charge-limit dial)
// renders as a read-only status indicator instead of a tappable control —
// this display has no touchscreen, so wiring onClick handlers a finger can
// never reach was pointless. Achieved via VehicleCard's `interactive={false}`
// prop; everything else (data fetching, refresh cadence, layout, styling,
// camera modal, settings link) is intentionally identical to app/page.tsx.
// ─────────────────────────────────────────────────────────────────────────
