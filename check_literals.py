...
LITERALS = [[None, 'buildInfluxWriteRequest'], [None, 'buildTelemetryPoints'], [None, 'pointsToLineProtocol'], [None, '/api/v2/write'], [None, 'precision=ms'], [None, 'encodeURIComponent'], [None, 'Token '], [None, 'text/plain; charset=utf-8']]
