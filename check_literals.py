...
TARGET = pathlib.Path('server/telemetry-server.js')

# frozen from TASK.md -- re-run `ollama-dispatch-scaffold --freeze-literals .`
LITERALS = [[None, "require('./telemetry-influx')"], [None, 'buildInfluxWriteRequest'], [None, 'maybeWriteInflux'], [None, 'getVacationMode'], [None, 'INFLUX_URL'], [None, 'INFLUX_TOKEN'], [None, 'INFLUX_ORG'], [None, 'INFLUX_BUCKET'], [None, 'fetch('], [None, 'require.main === module'], [None, 'module.exports']]
