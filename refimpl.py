...
NEW_VIN = OLD_VIN + (
    ...
    "      .catch((e) => console.error('[telemetry] influx write failed:', e)); //# relevance: unobservable -- error logging\n"
    "  } catch (e) {\n"
    "    console.error('[telemetry] influx write failed:', e); //# relevance: unobservable -- error logging\n"
    "  }\n"
    "}"
)
...
NEW_WS = (
    ...
    "    console.error('[telemetry] write failed:', e.message);\n"
    "  }\n"
    "  // Best-effort InfluxDB dual-write -- fire-and-forget; maybeWriteInflux is\n"
    "  // self-contained (never throws, swallows async errors).\n"
